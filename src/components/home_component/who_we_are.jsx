        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          <div className="grid-cols-1 lg:col-span-6 who_we_are">
            <div className="content-wrapper mt-10">
              ...
              <h6 className="mt-4">
                We are a leading full-service marketing company. We elevate
                businesses with innovative marketing strategies to ensure
                maximum growth.
              </h6>
              <button
          ...
          <div className="grid-cols-1 lg:col-span-6 justify-center sm:ml-6 mbl_image">
            <div className="box relative">
              <img
                src={Rectangle_5}
                alt=""
                className="who_we_are_image absolute"
              />

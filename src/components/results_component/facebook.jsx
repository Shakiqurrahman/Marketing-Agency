...
const Facebook = () => {
    ...
    return (
        ...
        >
            <div className="facebook" style={{ marginTop: 300, marginBottom: 200 }}>
                <div className="insta-result">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12">
                        ...
                        <div className="grid-cols-1 md:col-span-6 mx-auto relative inst_responsive">
                            ...
                            <img className='relative tiktok-result-image'  src={facebook1} alt="" />
                        </div>

                        <div className="grid-cols-1 md:col-span-6 mx-auto relative mbl_margin_top">
                            <div className='insta-result-box absolute inset-0 blur-lg brightness-120'>
                            </div>
                            <img className='relative tiktok-result-image' src={facebook2} alt="" />
                        </div>
                    </div>
                </div>
            </div>

            ...
            <div className="grid grid-cols-1 md:grid-cols-12">
                <div className="grid-cols-1 md:col-span-6 justify-center sm:ml-6 mbl_image services_image">
                    <div className='box relative'>
                        <img src={website} alt="" className='who_we_are_image absolute' />
                        <div className="image absolute"></div>
                    </div>
                </div>
                <div className="grid-cols-1 md:col-span-6 who_we_are right-column">
                    <div className=" service-content-wrapper website">
                        <h6>#4</h6>
                        <h3>WEBSITE DEVELOPMENT & SEO</h3>
                        <div className="list mt-10">
                            <li>High Quality Website Creation</li>
                            <li>High Ranking SEO</li>
                        </div>
